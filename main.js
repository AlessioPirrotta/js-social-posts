...
//  il colore al testo del bottone e incrementiamo il counter dei 
//  likes relativo.
// Salviamo in un secondo array gli id dei post ai quali
//  abbiamo messo il like.
// BONUS:
// Formattare le date in formato italiano (gg/mm/aaaa)
// Gestire l'assenza dell'immagine profilo con un elemento
//  di fallback che contiene le iniziali dell'utente 
//  (es. Luca Formicola > LF).
// Al click su un pulsante "Mi Piace" di un post, se abbiamo 
// già cliccato dobbiamo decrementare il contatore e cambiare 
// il colore del bottone.
// Consigli del giorno:
// Ragioniamo come sempre a step. Prima scriviamo nei commenti 
// la logica in italiano e poi traduciamo in codice. console.log() è
//  nostro amico. Quando un pezzo di codice funziona, chiediamoci se 
//  possiamo scomporlo in funzioni più piccole.
// Buon lavoro!
const posts = [
    {
        "id": 1,
...
posts.forEach((element,index)=>{
     ...
     cardContainer.innerHTML+= `<div class="post">
     ...
     <div class="post__footer">
         <div class="likes js-likes">
             <div class="likes__cta">
                 <button id="btn" class="like-button js-like-button" href="#" data-postid=${element.id}>
...
const likeCounter = document.querySelectorAll(".js-likes-counter");
 ...
 likeButtons.forEach((element, index)=>{
    ...
    likeCounter[index].innerText= posts[index].likes
    arrayPostLikes.push(posts[index])
